...
/* AUTHOR : Jiin Jeong                                                        */
/* DESC   : Q1 (Circle geometry for round tables)                             */
/*                                                                            */
/******************************************************************************/
...
const CircleGeometry = function(gl) {
  ...
  /****************************** VERTEX BUFFER ******************************/
  // Equation for making circle vertex points.
  let points = [0, 0, 0];
  var phi;
  for (phi = 0; phi <= 2 * (Math.PI); phi += ((Math.PI) / 32)) { 
    points.push(Math.cos(phi), Math.sin(phi), 0);
  }
  ...
  /****************************** INDEX BUFFER ******************************/
  // Equation for making circle index points.
  let i;
  let indexPoints = [];
  for (i = 0; i < 64; i++) { 
  ...
  /****************************** COLOR BUFFER ******************************/
  // Equation for making circle color points.
  let q = 0;
  let colorPoints = [];
  while (q < 66){
